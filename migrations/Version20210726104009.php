 ...
 */
final class Version20210726104009 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_details ADD product INT NOT NULL');
        $this->addSql('ALTER TABLE product ADD local INT DEFAULT NULL');
        $this->addSql('ALTER TABLE publication ADD updated_at DATETIME NOT NULL, ADD titre VARCHAR(255) DEFAULT NULL, ADD views VARCHAR(255) DEFAULT NULL, ADD viewsno INT NOT NULL, CHANGE description description MEDIUMTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP local');
        $this->addSql('ALTER TABLE publication DROP updated_at, DROP titre, DROP views, DROP viewsno, CHANGE description description VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
